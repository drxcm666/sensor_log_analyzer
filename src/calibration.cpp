...
{
    M.a[0][0] = x[0];  M.a[0][1] = x[1];  M.a[0][2] = x[2];
    M.a[1][0] = x[3];  M.a[1][1] = x[4];  M.a[1][2] = x[5];
    M.a[2][0] = x[6];  M.a[2][1] = x[7];  M.a[2][2] = x[8];
